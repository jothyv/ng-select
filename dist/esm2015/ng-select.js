...
class ItemsList {
    ...
    _groupBy(items, prop) {
        ...
        const groups = items.reduce((grouped, item) => {
            /** @type {?} */
            const key = isPropFn ? (/** @type {?} */ (prop)).apply(this, [item.value]) : item.value[/** @type {?} */ (prop)];
            /** @type {?} */
...
class NgDropdownPanelComponent {
    ...
    _handleDropdownPosition() {
        ...
        /** @type {?} */
        const selectEl = this._selectElementRef.nativeElement;
    ...
    _calculateCurrentPosition(dropdownEl) {
        ...
        /** @type {?} */
        const selectRect = this._selectElementRef.nativeElement.getBoundingClientRect();
        /** @type {?} */
